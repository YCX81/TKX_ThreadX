...
|----------|-------------|-----------------|
| [Architecture Design](EN/ARCHITECTURE.md) | System architecture, memory layout, state machine | Architects, Developers |
| [Bootloader](EN/BOOTLOADER.md) | Safe boot bootloader design and implementation | Low-level Developers |
| [Safety Modules](EN/SAFETY_MODULES.md) | Safety module API and usage guide | Safety Developers |
| [Service Layer](EN/SERVICES.md) | Parameter service, diagnostic service | Application Developers |
| [Application Layer](EN/APP_LAYER.md) | Application thread development guide | Application Developers |
